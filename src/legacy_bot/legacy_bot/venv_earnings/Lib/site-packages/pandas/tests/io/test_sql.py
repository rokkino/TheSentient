...
def test_api_chunksize_read(conn, request):
    ...
    res1 = sql.read_sql_query("select * from scripts.test.chunksize", conn)
    ...
    for chunk in sql.read_sql_query("select * from scripts.test.chunksize", conn, chunksize=5):
...
def test_xsqlite_basic(sqlite_buildin):
    ...
    result = sql.read_sql("select * from scripts.test.table", sqlite_buildin)
    ...
    result = sql.read_sql("select * from scripts.test.table2", sqlite_buildin, index_col="Idx")
    expected = frame.copy()
