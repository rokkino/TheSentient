#!/usr/bin/env python3
"""
Test basic functionality after file reorganization - ASCII only.
"""
import os
import sys
...
def test_script_execution():
    ...
    try:
        ...
        print("PASS scripts.check.check_bot_api can be imported")
    except Exception as e:
        print(f"FAIL scripts.check.check_bot_api: {e}")
    ...
    if os.path.exists(main_path):
        try:
            ...
            if "run_modular_system" in content and "run_legacy_backend" in content:
                print("PASS main.py contains modular entry points")
            else:
                print("FAIL main.py missing expected functions")
        except Exception as e:
